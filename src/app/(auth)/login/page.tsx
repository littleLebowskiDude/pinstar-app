  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        setMessage({
          type: 'error',
          text: `${error.message}. Please check your Supabase email settings.`,
        })
      } else {
        setMessage({
          type: 'success',
      ...
      setMessage({
        type: 'error',
        text: 'An unexpected error occurred. Please check the console and your Supabase configuration.',
      })
    } finally {
      setLoading(false)
    }
